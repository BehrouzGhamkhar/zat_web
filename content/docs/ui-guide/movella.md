...
{{< hint info >}}
📸 **Screenshot placeholder** — *One panel collapsed and one expanded, showing the chevron icons*
{{< /hint >}}
...
{{< hint info >}}
📸 **Screenshot placeholder** — *Sensor toggle bar with some sensors unchecked*
{{< /hint >}}

| Control | Effect |
|---|---|
| Checkbox **checked** | Sensor's data lines are visible in all graphs |
| Checkbox **unchecked** | Sensor is hidden from all graphs (data is still collected in the background) |
...
- Sensors are **dynamically discovered** on page load. If no sensors are connected, the toggle bar and graphs will be empty.

---

## Troubleshooting

**Graphs are empty / no lines appear**
...
**One sensor is missing from the toggle bar**
